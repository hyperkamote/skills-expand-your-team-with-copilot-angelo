...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', or 'All' for activities with no difficulty set). Empty string returns all activities regardless of difficulty.
    """
    ...
    if difficulty:
        if difficulty == "All":
            # "All" means activities with no difficulty field set
